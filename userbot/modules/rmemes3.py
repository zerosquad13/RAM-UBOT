...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**OWNER XXX SQUAD ADALAH MANUSIA TERKEREN DI TELE, KENALAN DULU SAMA OWNER NYA YUK**"
            "**SINNER NAMANYA,ORANG NYA GA BAIK**"
            "**BAIK KLO DIKASI PAP, APALAGI DIAJAKIN PICIES**"
            "**KALO MAU TAU LAGI, MENDING PC AJA**"
            "**POKOK NYA OWNER NYA HYPER BANGET SERIUSSSSS**"
            "**UDAH POKOK NYA ITU AJA SIH,INTINYA OWNER NYA KEREN TAPI SANGEAN**"]
