...
DEF_UNAPPROVED_MSG = (
    ...
    "**╰━━━━━━━━━━━━━━━━━╯**\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"**SABAR YA TUNGGU SAMPE DIBALES**\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 💣𝐬𝐢𝐧𝐧𝐞𝐫𝐗𝐫𝐨𝐛𝐨𝐭💥\n"
...
async def approvepm(apprvpm):
    ...
    await apprvpm.edit(f"`Baik` [{name0}](tg://user?id={uid}) `Ok pesan Lu udah di terima.`")
    ...
    if event.is_private:
        if not pm_permit_sql.is_approved(chats.id):
            pm_permit_sql.approve(
                chats.id, f"`SINNER TELAH MENGIRIM PESAN UNTUK ANDA 💣`")
