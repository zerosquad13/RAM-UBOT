...
gesss = [
    "**Eh ada Sinner keren🤎**",
    "**Hadir Sinner ganteng** 😍",
    "**Hi, Sinner kemana sj?** 🤗",
    "**Hadir kak** 😉",
    "**Hadir bang Sinner** 😁",
    "**Hadir Sinner maap telat** 🥺",
    "**Saya slalu ada buat bang Sinner🥵**",
    "**Bang Sinner, Aku ange😋😋**",
    "**Jangan kemana mana lagi ya bang🥰**",
    "**Pas banget bang, aku lagi kangen🥺**",
    "**Bang Sinner on juga akhirnya**😍",
    "**Mau pap dari aku ndak** 😋",
    "**Salam hormat buat bang Sinner** 🤗",
]
